...
// 13.02.2026 14:00 - UPDATE: GLOBAL SITE-SPECIFIC QUERIES.
// - Logic: Equipped ALL countries with precise 'site:' Google Operators.
// - Logic: Enables deep-mining of guide databases worldwide.

export const metadata = {
    lastUpdated: "2026-02-13T14:00:00.000Z"
};

export interface GuideDef {
    name: string;
    searchUrl: string;
    googleQueries?: string[]; // Active Search Commands with [CITY] placeholder
    searchTerms: string[];
}
...
export const countryGuideConfig: Record<string, GuideDef[]> = {
    ...
    "Polen": [
        { 
            ...
            googleQueries: ["Gault&Millau Poland [CITY]", "Zolty Przewodnik [CITY]"],
            searchTerms: ["Czapki", "Punkty"] 
        }, 
        { 
            name: "Michelin", 
            searchUrl: "https://guide.michelin.com/pl/en/restaurants", 
            googleQueries: ["site:guide.michelin.com/pl/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Poland 100 Best", 
            searchUrl: "https://poland100best.pl/", 
            googleQueries: ["site:poland100best.pl [CITY]"],
            searchTerms: ["Award", "Best Restaurant"] 
        }
    ],
    "Tschechien": [
        { 
            ...
            googleQueries: ["site:gastromapa.hejlik.cz [CITY]", "Gastromapa [CITY]"],
            searchTerms: ["Doporuceni", "Gastromapa"] 
        },
        { 
            name: "Maurer's Grand Restaurant Selection", 
            searchUrl: "https://www.grand-restaurant.cz/", 
            googleQueries: ["site:grand-restaurant.cz [CITY]"],
            searchTerms: ["Maurer", "Selection"] 
        },
        { 
            name: "Michelin", 
            searchUrl: "https://guide.michelin.com/cz/en/restaurants", 
            googleQueries: ["site:guide.michelin.com/cz/en [CITY]"],
            searchTerms: ["Bib Gourmand", "Plate"] 
        }
    ],
    "Ungarn": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/hu/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Dining Guide", 
            searchUrl: "https://diningguide.hu/", 
            googleQueries: ["site:diningguide.hu [CITY]", "Dining Guide Top 100 [CITY]"],
            searchTerms: ["Top 100", "Award"] 
        }
    ],
    ...
    "Italien": [
        { 
            ...
            googleQueries: ["site:gamberorosso.it [CITY] Ristorante", "Gambero Rosso [CITY]"],
            searchTerms: ["Forchette", "Gamberi", "Spicchi"] 
        },
        { 
            name: "Slow Food (Osterie d'Italia)", 
            searchUrl: "https://www.slowfood.it/osteria-ditalia-subs/", 
            googleQueries: ["site:slowfood.it [CITY]", "Osterie d'Italia [CITY]"],
            searchTerms: ["Chiocciola", "Osterie d'Italia"] 
        },
        { 
            name: "Michelin", 
            searchUrl: "https://guide.michelin.com/it/it/ristoranti", 
            googleQueries: ["site:guide.michelin.com/it/it [CITY]"],
            searchTerms: ["Stella", "Bib Gourmand"] 
        },
        { 
            name: "L'Espresso", 
            searchUrl: "https://guide.espresso.repubblica.it/", 
            googleQueries: ["Guida Espresso Ristoranti [CITY]", "I Ristoranti e i Vini d'Italia [CITY]"],
            searchTerms: ["Cappello", "Espresso"] 
        }
    ],
    "Frankreich": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/fr/fr [CITY]"],
            searchTerms: ["Etoile", "Bib Gourmand"] 
        },
        { 
            name: "Gault&Millau", 
            searchUrl: "https://fr.gaultmillau.com/s", 
            googleQueries: ["site:fr.gaultmillau.com [CITY]", "Gault Millau France [CITY]"],
            searchTerms: ["Toques", "Points"] 
        },
        { 
            name: "Le Fooding", 
            searchUrl: "https://lefooding.com/search/restaurant", 
            googleQueries: ["site:lefooding.com [CITY]"],
            searchTerms: ["Fooding", "Cool"] 
        },
        { 
            name: "La Liste", 
            searchUrl: "https://www.laliste.com/en/", 
            googleQueries: ["site:laliste.com [CITY]"],
            searchTerms: ["La Liste", "Score"] 
        }
    ],
    "Spanien": [
        { 
            ...
            googleQueries: ["site:guiarepsol.com [CITY]", "Guía Repsol [CITY] Soles"],
            searchTerms: ["Sol", "Soles"] 
        },
        { 
            name: "Michelin", 
            searchUrl: "https://guide.michelin.com/es/es/restaurantes", 
            googleQueries: ["site:guide.michelin.com/es/es [CITY]"],
            searchTerms: ["Estrella", "Bib Gourmand"] 
        },
        { 
            name: "Macarfi", 
            searchUrl: "https://www.macarfi.com/", 
            googleQueries: ["site:macarfi.com [CITY]"],
            searchTerms: ["Top 10", "Recommended"] 
        }
    ],
    "Portugal": [
        { 
            ...
            googleQueries: ["site:boacamaboamesa.expresso.pt [CITY]"],
            searchTerms: ["Chave", "Garfo"] 
        },
        { 
            name: "Michelin", 
            searchUrl: "https://guide.michelin.com/pt/pt/restaurantes", 
            googleQueries: ["site:guide.michelin.com/pt/pt [CITY]"],
            searchTerms: ["Estrela", "Bib Gourmand"] 
        }
    ],
    "Griechenland": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/gr/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "FNL Guide", 
            searchUrl: "https://www.fnl-guide.com/", 
            googleQueries: ["site:fnl-guide.com [CITY]", "FNL Guide Awards [CITY]"],
            searchTerms: ["Star", "Award"] 
        },
        { 
            name: "Greek Cuisine Awards", 
            searchUrl: "https://www.athinorama.gr/restaurant/awards/", 
            googleQueries: ["site:athinorama.gr [CITY] award"],
            searchTerms: ["Award", "Toque d'Or"] 
        }
    ],
    "Kroatien": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/hr/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Gault&Millau", 
            searchUrl: "https://hr.gaultmillau.com/", 
            googleQueries: ["site:hr.gaultmillau.com [CITY]"],
            searchTerms: ["Toques", "Points"] 
        },
        { 
            name: "Dobri restorani", 
            searchUrl: "https://dobrahrana.jutarnji.hr/dobri-restorani/", 
            googleQueries: ["Dobri restorani [CITY]"],
            searchTerms: ["Best Restaurants"] 
        }
    ],
    ...
    "Japan": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/jp/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Tabelog", 
            searchUrl: "https://tabelog.com/en/rst/rstlst/", 
            googleQueries: ["site:tabelog.com/en [CITY] Award", "Tabelog Bronze Silver Gold [CITY]"],
            searchTerms: ["Bronze", "Silver", "Gold", "100 Famous Stores"] 
        },
        { 
            name: "Asia's 50 Best", 
            searchUrl: "https://www.theworlds50best.com/asia/en/list/1-50", 
            googleQueries: ["site:theworlds50best.com/asia [CITY]"],
            searchTerms: ["50 Best"] 
        }
    ],
    "Thailand": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/th/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Wongnai Users' Choice", 
            searchUrl: "https://www.wongnai.com/listings/users-choice", 
            googleQueries: ["site:wongnai.com [CITY] Users' Choice"],
            searchTerms: ["Users' Choice"] 
        },
        { 
            name: "BK Magazine Top Tables", 
            searchUrl: "https://bk.asia-city.com/restaurants/top-tables", 
            googleQueries: ["BK Magazine Top Tables [CITY]"],
            searchTerms: ["Top Tables"] 
        },
        { 
            name: "Asia's 50 Best", 
            searchUrl: "https://www.theworlds50best.com/asia/en/list/1-50", 
    ...
    "Singapur": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/sg/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Burpple", 
            searchUrl: "https://www.burpple.com/sg", 
            googleQueries: ["site:burpple.com/sg [CITY] Guide"],
            searchTerms: ["Burpple Guide"] 
        },
        { 
            name: "Asia's 50 Best", 
            searchUrl: "https://www.theworlds50best.com/asia/en/list/1-50", 
    ...
    "Vietnam": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/vn/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "VietnamMM (Foody)", 
            searchUrl: "https://www.foody.vn/", 
            googleQueries: ["site:foody.vn [CITY]"],
            searchTerms: ["Best"] 
        },
        { 
            name: "Asia's 50 Best", 
    ...
    "Sri Lanka": [
        { 
            ...
            googleQueries: ["site:yamu.lk [CITY] Best"],
            searchTerms: ["Recommended"] 
        },
        { 
            name: "Pulse.lk", 
            searchUrl: "https://www.pulse.lk/", 
            googleQueries: ["site:pulse.lk [CITY] Dining"],
            searchTerms: ["Review"] 
        },
        { 
            name: "Asia's 50 Best", 
    ...
    "USA": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/us/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "James Beard Foundation", 
            searchUrl: "https://www.jamesbeard.org/awards", 
            googleQueries: ["James Beard Award [CITY] Restaurant"],
            searchTerms: ["James Beard", "Award"] 
        },
        { 
            name: "Zagat", 
            searchUrl: "https://www.zagat.com/", 
            googleQueries: ["Zagat [CITY] Best Restaurants"],
            searchTerms: ["Zagat Rated"] 
        },
        { 
            name: "The Infatuation", 
            searchUrl: "https://www.theinfatuation.com/", 
            googleQueries: ["site:theinfatuation.com [CITY]"],
            searchTerms: ["Review", "Approved"] 
        },
        { 
            name: "Eater", 
            searchUrl: "https://www.eater.com/", 
            googleQueries: ["site:eater.com [CITY] 38", "Eater [CITY] Heatmap"],
            searchTerms: ["Eater 38", "Heatmap"] 
        }
    ],
    "Kanada": [
        { 
            ...
            googleQueries: ["site:guide.michelin.com/ca/en [CITY]"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "Canada's 100 Best", 
            searchUrl: "https://canadas100best.com/", 
            googleQueries: ["site:canadas100best.com [CITY]"],
            searchTerms: ["100 Best"] 
        },
        { 
            name: "En Route", 
            searchUrl: "https://enroute.aircanada.com/en/restaurants/", 
            googleQueries: ["site:enroute.aircanada.com [CITY]"],
            searchTerms: ["Best New Restaurant"] 
        }
    ],
    ...
    "Australien": [
        { 
            ...
            googleQueries: ["site:goodfood.com.au [CITY] Hat"],
            searchTerms: ["Hat", "Chef's Hat"] 
        },
        { 
            name: "Gourmet Traveller", 
            searchUrl: "https://www.gourmettraveller.com.au/dining-out/restaurant-guide", 
            googleQueries: ["site:gourmettraveller.com.au [CITY]"],
            searchTerms: ["Star", "Review"] 
        },
        { 
            name: "Australian Good Food & Travel Guide", 
            searchUrl: "https://www.agfg.com.au/", 
            googleQueries: ["site:agfg.com.au [CITY] Chef Hat"],
    ...
    "Neuseeland": [
        { 
            ...
            googleQueries: ["site:cuisine.co.nz [CITY] Hat"],
            searchTerms: ["Hat", "Award"] 
        },
        { 
            name: "Metro Top 50", 
            searchUrl: "https://www.metro.co.nz/food/top-50-restaurants", 
            googleQueries: ["site:metro.co.nz [CITY] Top 50"],
            searchTerms: ["Top 50"] 
        }
    ],
    "Südafrika": [
...
export function getGuidesForCountry(countryName: string | undefined): GuideDef[] {
    ...
    return [
        { 
            name: "Michelin International", 
            searchUrl: "https://guide.michelin.com", 
            googleQueries: ["site:guide.michelin.com [CITY] Restaurant"],
            searchTerms: ["Star", "Bib Gourmand"] 
        },
        { 
            name: "TripAdvisor (Best Fine Dining)", 
            searchUrl: "https://www.tripadvisor.com", 
            googleQueries: ["TripAdvisor Best Fine Dining [CITY] List"], 
            searchTerms: ["Travelers' Choice"] 
        },
         { 
            name: "50 Best Discovery", 
            searchUrl: "https://www.theworlds50best.com/discovery", 
            googleQueries: ["site:theworlds50best.com [CITY]"],
            searchTerms: ["50 Best"] 
        }
    ];
}
// --- END OF FILE 482 Lines ---