// 23.02.2026 20:30 - FEAT: Expanded 'travel_info' climate prompt to mandate specific metrics (max/min temp, water temp, rainy days).
// 23.02.2026 19:35 - FIX: Added 'hotel' to VALID_POI_CATEGORIES. Restored 1:1 file integrity.
