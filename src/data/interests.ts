...
export const INTEREST_DATA: Record<string, InterestCategory> = {
  ...
  'Restaurant': {
    ...
    searchStrategy: {
      de: "STRATEGIE: 3-STUFEN-PROZESS. 1. SCAN: Suche breit nach Guide-Einträgen in der Region. 2. FILTER: Der Code filtert nach Distanz (Radius).",
      en: "STRATEGY: 3-STEP PROCESS. 1. SCAN: Broad search for guide entries in the region. 2. FILTER: Code filters by distance (radius)."
    },
    writingGuideline: {
      de: "3. ENRICH: Beschreibe die verbleibenden Kandidaten detailliert.",
      en: "3. ENRICH: Describe the remaining candidates in detail."
    },
    aiInstruction: {
  ...
  'Museum': {
    ...
    searchStrategy: {
      ...
      en: "SEARCH STRATEGY: Search for a diverse mix. 1. PRIORITY: Look for 'High Art' (Picasso, Monet, etc.) and significant collections. 2. FALLBACK & ADDITION: If no world-class art is available or for variety, switch immediately to high-quality regional museums (open-air, history, archaeology)."
    },
    writingGuideline: {
      de: "REDAKTIONS-ANWEISUNG: Erstelle für jedes im Reiseplan erwähnte Museum einen detaillierten Eintrag im Anhang.\n\n**Teil 1: Museumsbeschreibung (ca. eine halbe DIN A4 Seite):** Schreibe eine lebendige Beschreibung (Bezug zu Interessen, Sammlungs-Schwerpunkte, Architektur).\n\n**Teil 2: Top-Exponate:** Liste die Top 10 wichtigsten Exponate auf (Künstler, Titel, Erklärung).\n\n**Teil 3: Praktische Informationen:** Übersicht zu Öffnungszeiten, Ticketpreisen und Kauf-Empfehlung.",
      en: "EDITORIAL INSTRUCTION: Create a detailed entry in the appendix for each museum.\n\n**Part 1: Museum Description (approx. half an A4 page):** Vivid description (relate to interests, collection highlights, architecture).\n\n**Part 2: Top Exhibits:** List Top 10 important exhibits (artist, title, explanation).\n\n**Part 3: Practical Information:** Opening hours, prices, ticket advice."
    },
    aiInstruction: {
  ...
  'Architektur': {
    ...
    writingGuideline: {
      de: "REDAKTIONS-ANWEISUNG: Erstelle für jede Sehenswürdigkeit einen detaillierten Eintrag im Anhang. Gliedere zwingend:\n\n**Teil 1: Architektur, Erbauer und historische Bedeutung**\nLebendige Beschreibung (Stil, Architekt, Bauzeitraum, ursprünglicher Zweck, Bedeutung).\n\n**Teil 2: Top 5 – Die wichtigsten Fakten und Merkmale**\nListe die 5 interessantesten Fakten (Details, Symbole, Events, Anekdoten).",
      en: "EDITORIAL INSTRUCTION: Create a detailed entry in the appendix. Structure strictly:\n\n**Part 1: Architecture, Builder, and Historical Significance**\nVivid description (style, architect, period, purpose, significance).\n\n**Part 2: Top 5 – Key Facts and Features**\nList 5 interesting facts (details, symbols, events, anecdotes)."
    },
    aiInstruction: {
  ...
  'Stadtbezirke': {
    ...
    searchStrategy: {
      de: "SUCH-STRATEGIE: Suche nach einer **Mischung** aus den **Must-See-Vierteln (z.B. Altstadt)** und den **authentischen, weniger touristischen Bezirken (Hidden Gems)**. Wenn die Stadt **mehrere** Viertel von Interesse hat, schlage **mehrere** vor.",
      en: "SEARCH STRATEGY: Search for a **mix** of **must-see districts (e.g., Old Town)** and **authentic, less touristy neighborhoods (Hidden Gems)**. If city has **multiple** districts, suggest **several**."
    },
    writingGuideline: {
      de: "REDAKTIONS-ANWEISUNG: Erstelle im Anhang einen detaillierten Spaziergang. Einleitung zur Atmosphäre. Logische Route mit 5-7 Stationen (Plätze, Straßen, Gebäude, Höfe). Beschreibe jede Station. Empfiehl 1-2 authentische Cafés.",
      en: "EDITORIAL INSTRUCTION: Create a detailed walk in the appendix. Intro on atmosphere. Logical route with 5-7 stops (squares, streets, buildings, courtyards). Describe each stop. Recommend 1-2 authentic cafes."
    },
    aiInstruction: {
  ...
  'Natur': {
    ...
    searchStrategy: {
      ...
      en: "SEARCH STRATEGY: Search for natural beauties matching the activity level. Prioritize places with 'wow factor' (view, waterfall). Do **not** exclude top destinations due to popularity."
    },
    writingGuideline: {
      de: "REDAKTIONS-ANWEISUNG: Beschreibe jede geplante Natur-Aktivität detailliert im Anhang. Details zu Startpunkt, Länge (km), Dauer, Schwierigkeitsgrad, Höhenmetern. Charakter der Landschaft und Tour-Highlights. Praktische Tipps zur Ausrüstung.",
      en: "EDITORIAL INSTRUCTION: Describe nature activities in detail in the appendix. Details on start, length (km), duration, difficulty, elevation. Landscape character and highlights. Gear tips."
    },
    aiInstruction: {
  ...
  'Sport': {
    ...
    searchStrategy: {
      de: 'Plane aktive körperliche Betätigung ein. Suche nach konkreten Routen (Wandern zwischen 700 und 1100 Höhenmetern und bis zu 15 Kilometer, Radfahren bis zu 55 Kilometer), Verleihstationen oder Sportstätten.',
      en: 'Plan physical exercise. Search for specific routes (hiking 700-1100m, up to 15km; cycling up to 55km), rental stations or sports facilities.'
    },
    writingGuideline: {
      de: 'Gib Details zu Schwierigkeitsgrad und Dauer an.',
      en: 'Provide details on difficulty and duration.'
    },
    aiInstruction: {
